...
<link rel="stylesheet" href="/resources/css/qa.css" />
		...
		<div class="row">
			...
			<div id="content" class="8u skel-cell-important">
				<section>
					...
					<div class="row">
						<form id='searchForm' action="/community/cdims_qa" method='get'
					...
					<form id="actionForm" action="/community/cdims_qa" method="get">
...
$(document).ready(function() {
	...
	$("#writeBtn").on("click", function() {
		self.location ="/community/cdims_qa_write";
	});
	...
	$(".move").on("click", function(e) {
		...
		actionForm.attr("action", "/community/cdims_qa_get");
		actionForm.submit();
	});
