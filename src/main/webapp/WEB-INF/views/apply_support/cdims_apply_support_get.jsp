...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("button[data-oper='approval_cancel']").on("click", function(e) {
			...
			applySupportService.update(approvalStatus, function(result) {
				if (result == "success") {
					alert('승인취소되었습니다.');
		...
		$("button[data-oper='modify']").on("click", function(e) {
			frm.attr("action", "/apply_support/cdims_apply_support_update");
			frm.attr("method", "get");
			frm.submit();
		});
		...
		$("button[data-oper='list']").on("click", function(e) {
			self.location = "/apply_support/cdims_apply_support";
		});
	});
