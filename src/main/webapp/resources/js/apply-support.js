 ...
 * 
 */
console.log("applySupport Module!");

var applySupportService = (function() {
	...
	function getList(param, callback, error) {
		...
		$.getJSON("/apply_support/list/" + year + "/" + semester + "/" + subjectName + "/" + division + ".json",
				function(data) {
					if (callback) {
	...
	function update(approvalStatus, callback, error) {
		...
		$.ajax({
			type : 'put',
			url : '/apply_support/' + approvalStatus.teamno + "/" + approvalStatus.approval, 
