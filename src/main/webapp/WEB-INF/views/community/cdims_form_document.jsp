...
<link rel="stylesheet" href="/resources/css/form_document.css" />
		...
		<div class="row">
			...
			<div id="content" class="8u skel-cell-important">
				<section>
					...
					<div class="row">
						<form id='searchForm' action="/community/cdims_form_document" method='get'
					...
					<form id="actionForm" action="/community/cdims_form_document" method="get">
...
$(document).ready(function() {
	...
	$("#writeBtn").on("click", function() {
		self.location ="/community/cdims_form_document_write";
	});
	...
	$(".move").on("click", function(e) {
		...
		actionForm.attr("action", "/community/cdims_form_document_get");
		actionForm.submit();
	});
	
	/* 검색 처리(search) 버튼 이벤트 */
	var searchForm = $("#searchForm"); //Form태그의 id(searchForm) 값을 가져옴
