		...
		<div class="row">
			...
			<div id="content" class="8u skel-cell-important">
				<section>
					...
					<form role="form" action="/community/cdims_qa_update" method="post">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('button').on("click", function(e) {
			...
			if (operation === 'remove') {
				formObj.attr("action", "/community/cdims_qa_delete");
				formObj.submit();
				
			} else if (operation === 'list') {
				//move to list
				formObj.attr("action", "/community/cdims_qa").attr("method", "get");
